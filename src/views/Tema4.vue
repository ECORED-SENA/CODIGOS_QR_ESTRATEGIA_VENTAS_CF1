...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.mb-4
          ...
          table
            thead
              tr
                ...
                th.text-white Empresa
            tbody
              tr
                th Prestigio- confianza
                td Ingresos
              tr
                th Servicios
                td Expansión
              tr
                th Precios
                td Nuevas líneas de la marca
              tr
                th Promociones
                td Eficiencia - Eficacia
              tr
                th Post -venta
      ...
      .col-lg-6.mb-4
        ul.lista-ul--color
          li 
            i.lista-ul__vineta
            | Los responsables de su manejo deben cuidar su esencia.
          li 
            i.lista-ul__vineta
            | Respetar su imagen corporativa.
          li 
            i.lista-ul__vineta
            | Cumplir con su propósito.
          li 
            i.lista-ul__vineta
            | Dar siempre a conocer las bondades de la marca y sus productos.
          li 
            i.lista-ul__vineta
            | El cliente siempre será embajador de la marca si está contento con ella.
          li 
            i.lista-ul__vineta
            | Empatía por la marca.
          li 
            i.lista-ul__vineta
            | Generar experiencia sensorial con la marca.
          li 
            i.lista-ul__vineta
            | Crear confianza a los clientes esto genera fidelidad.
          li 
            i.lista-ul__vineta
            | Aprender a contar historias de la marca.
          li 
            i.lista-ul__vineta
            | Servir a la marca y al cliente nos ayuda a construir relaciones para generaciones.
    ...
    .row.justify-content-center.mb-4  
      .col-lg-10
        p.mb-4 Cuando le damos valor a la marca con nuevas herramientas como la aplicación de los códigos QR el cliente se motiva y genera no solo publicidad al comentar si no se fideliza porque le ayuda a ahorrar tiempo y dinero, él puede desde su dispositivo móvil a la hora que se le facilite realizar sus compras o pagos de todos los productos y servicios.
        .h4.mb-4
          <div style="color:#7714B7;"> ● Síntesis </div>
